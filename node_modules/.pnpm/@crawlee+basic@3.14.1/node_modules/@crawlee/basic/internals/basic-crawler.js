...
class BasicCrawler {
    ...
    constructor(options = {}, config = core_1.Configuration.getGlobalConfig()) {
        ...
        Object.defineProperty(this, "shouldLogMaxProcessedRequestsExceeded", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        });
        Object.defineProperty(this, "shouldLogMaxEnqueuedRequestsExceeded", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        ...
        const { requestList, requestQueue, maxRequestRetries = 3, sameDomainDelaySecs = 0, maxSessionRotations = 10, maxRequestsPerCrawl, maxCrawlDepth, autoscaledPoolOptions = {}, keepAlive, sessionPoolOptions = {}, useSessionPool = true, 
                ...
                async function* injectDepth() {
                    for await (const rq of requests) {
                        if (typeof rq === 'string') {
                            ...
                            rq.crawlDepth ?? (rq.crawlDepth = newRequestDepth);
                            yield rq;
                        }
                    }
                }
